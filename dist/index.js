...
var moduleProgress = mysqlTable("module_progress", {
  id: int("id").autoincrement().primaryKey(),
  userId: int("userId").notNull(),
...
var quizAttempts = mysqlTable("quiz_attempts", {
  id: int("id").autoincrement().primaryKey(),
  userId: int("userId").notNull(),
  moduleNumber: int("moduleNumber").notNull(),
  // 1-6
...
var labCompletions = mysqlTable("lab_completions", {
  id: int("id").autoincrement().primaryKey(),
  userId: int("userId").notNull(),
  moduleNumber: int("moduleNumber").notNull(),
  labNumber: int("labNumber").notNull(),
  // e.g., 1, 2, 3 for labs within a module
...
var examAttempts = mysqlTable("exam_attempts", {
  ...
  // JSON string of answers for review
});
var certificates = mysqlTable("certificates", {
  ...
  capstoneProjectScore: int("capstoneProjectScore"),
  // Optional, for future use
  certificateUrl: text("certificateUrl")
  // URL to certificate PDF/image
});
var studentNotes = mysqlTable("student_notes", {
  id: int("id").autoincrement().primaryKey(),
  userId: int("userId").notNull(),
  moduleNumber: int("moduleNumber").notNull(),
